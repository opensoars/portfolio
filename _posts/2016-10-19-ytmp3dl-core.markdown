...
categories: projects
oneline: Reverse engineered Google's media signature enciphering. Ytmp3dl is a Node.js Youtube mp3 downloader module utilizing some of the latest (proposed) ECMAScript features.
---
